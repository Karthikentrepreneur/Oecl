        ...
        <section className="py-20 bg-gradient-to-r from-red-600/10 to-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-gray-300 text-lg">Numbers that speak to our commitment and excellence</p>
            </motion.div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="bg-gradient-to-r from-red-600/20 to-transparent p-8 rounded-2xl">
