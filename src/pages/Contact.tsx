...
const Contact = () => {
  ...
  return <div className="min-h-screen flex flex-col relative">
      ...
      {showNotification && <div className="fixed top-6 right-6 z-50 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-3 transition-all">
          <Send size={18} />
        ...
        <section className="py-16 bg-gradient-to-b from-red-50/30 to-white">
          <div className="container mx-auto px-4">
            ...
            duration: 0.5
              ...
              {isMobile && <div className="fixed top-20 left-0 right-0 z-30 bg-gradient-to-r from-red-600 to-red-700 p-3 text-white text-center shadow-md">
              ...
              {isMobile && <div className="fixed bottom-4 right-4 z-50 flex gap-2">
                  <Button onClick={() => setShowMap(!showMap)} className="bg-red-600 hover:bg-red-700 text-white shadow-lg" size="lg">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-1 gap-10 mb-10">
              ...
              duration: 0.8
                ...
                <form action={`https://formsubmit.co/ajax/${currentCountryInfo.email}`} method="POST" className="space-y-5">
                  ...
                  scale: 0.98
                    ...
                    <Button type="submit" className="w-full text-white py-6 flex items-center justify-center gap-2 bg-black hover:bg-red-700">
                      Send Message
                      <Send size={18} />
                    </Button>
                  </motion.div>
