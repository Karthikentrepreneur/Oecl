...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      {/* Main Content with Mobile Responsive Fix */}
      <div className="relative z-20 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-12">
        <div className="max-w-4xl w-full space-y-6 text-center sm:text-left sm:mx-0">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
            {currentSlide.title.split(" ").map((word, i) => (
              <span key={i} style={{ animationDelay: `${i * 0.1}s` }} className="text-slate-50">
                {word}{" "}
              </span>
            ))}
          </h1>
          <p
            className={`text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto sm:mx-0 leading-relaxed transform transition-all duration-1000 delay-500 ${
          ...
          <div
            className={`flex flex-col sm:flex-row gap-4 justify-center sm:justify-start transform transition-all duration-1000 delay-700 ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
          ...
          {/* Slide Indicators */}
          <div className="flex space-x-2 justify-center sm:justify-start pt-4">
